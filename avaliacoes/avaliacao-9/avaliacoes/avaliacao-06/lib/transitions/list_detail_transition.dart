...
class _ListDetailTransitionState extends State<ListDetailTransition> {
  ...
  void didChangeDependencies() {
    ...
    double nextFlexFactor = switch (width) {
      >= 800 && < 1200 => (lerpDouble(1000, 2000, (width - 800) / 400) ?? 0),
      >= 1200 && < 1600 => (lerpDouble(2000, 3000, (width - 1200) / 400) ?? 0),
      >= 1600 => 3000,
      _ => 1000,
    };
    ...
    if (currentFlexFactor == 0) {
      ...
      widthAnimation = sequence.animate(OffsetAnimation(parent: widget.animation));
    }
